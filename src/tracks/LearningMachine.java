...
//
    ...
    public static void runMultipleGames(String game_file, String[] level_files,
        ...
        CompetitionParameters.IS_LEARNING = true;
        //Create the player.
        System.out.println("checkpoint 1.0");
        LearningPlayer player = LearningMachine.createPlayer(cmd);
        System.out.println("checkpoint 2.0");
    ...
    public static void runGames(String game_file, String[] level_files, int level_times,
        ...
        Game toPlay = new VGDLParser().parseGame(game_file);
        int levelIdx = 0;
        System.out.println("NewCheckpoint 1");
        ...
        System.out.println("NewCheckpoint 1.5");
        // Initialize the player
        boolean initSuccesful = players[0].startPlayerCommunication();
        if (!initSuccesful) {
            System.out.println("CUECA BORRADA");
            return;
        }
        System.out.println("NewCheckpoint 2");
        ...
        System.out.println("NewCheckpoint3");
        level_idx = 0;
        int levelOutcome = 0;

...
public class SingleTreeNode
{
    ...
    public double normalise(double x, double min, double max)
    {
        if(min < max)
    ...
    public SingleTreeNode uct(StateObservation state) {
        ...
        double childmax = -Double.MAX_VALUE, childmin = Double.MAX_VALUE;
        ...
        for (SingleTreeNode child : this.children)
        {
            ...
            childValue = normalise(childValue, childmin, childmax);
            //childValue = Utils.normalise(childValue, bounds[0], bounds[1]);
//            System.out.println(childmin);

...
public class Types {
    ...
    public static enum ACTIONS {
        ...
        public static ArrayList<ACTIONS> getCloseActions(ACTIONS action){
            ArrayList<ACTIONS> closeActions = new ArrayList<>();
            if(action == ACTIONS.ACTION_DOWN){
                closeActions.add(ACTIONS.ACTION_UP);closeActions.add(ACTIONS.ACTION_LEFT);closeActions.add(ACTIONS.ACTION_RIGHT);closeActions.add(ACTIONS.ACTION_USE);closeActions.add(ACTIONS.ACTION_NIL);closeActions.add(ACTIONS.ACTION_ESCAPE);
            }
            else if(action == ACTIONS.ACTION_UP){
                closeActions.add(ACTIONS.ACTION_DOWN);closeActions.add(ACTIONS.ACTION_LEFT);closeActions.add(ACTIONS.ACTION_RIGHT);closeActions.add(ACTIONS.ACTION_USE);closeActions.add(ACTIONS.ACTION_NIL);closeActions.add(ACTIONS.ACTION_ESCAPE);
            }
            else if(action == ACTIONS.ACTION_LEFT || action == ACTIONS.ACTION_RIGHT){
                closeActions.add(ACTIONS.ACTION_UP);closeActions.add(ACTIONS.ACTION_DOWN);closeActions.add(ACTIONS.ACTION_USE);closeActions.add(ACTIONS.ACTION_NIL);closeActions.add(ACTIONS.ACTION_ESCAPE);
            }
            else if(action == ACTIONS.ACTION_USE){
                closeActions.add(ACTIONS.ACTION_DOWN);closeActions.add(ACTIONS.ACTION_LEFT);closeActions.add(ACTIONS.ACTION_RIGHT); closeActions.add(ACTIONS.ACTION_UP);closeActions.add(ACTIONS.ACTION_NIL);closeActions.add(ACTIONS.ACTION_ESCAPE);
            }
            else if(action == ACTIONS.ACTION_ESCAPE){
                closeActions.add(ACTIONS.ACTION_DOWN);closeActions.add(ACTIONS.ACTION_LEFT);closeActions.add(ACTIONS.ACTION_RIGHT); closeActions.add(ACTIONS.ACTION_UP);closeActions.add(ACTIONS.ACTION_NIL);closeActions.add(ACTIONS.ACTION_USE);
            }
            else if(action == ACTIONS.ACTION_NIL){
                closeActions.add(ACTIONS.ACTION_DOWN);closeActions.add(ACTIONS.ACTION_LEFT);closeActions.add(ACTIONS.ACTION_RIGHT); closeActions.add(ACTIONS.ACTION_UP);closeActions.add(ACTIONS.ACTION_USE);closeActions.add(ACTIONS.ACTION_ESCAPE);
            }
            return closeActions;
        }
    }

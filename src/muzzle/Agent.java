...
public class Agent extends AbstractPlayer {
    ...
    public Agent(StateObservation observation, ElapsedCpuTimer elapsedTimer, String error, String replayer){
        ...
        this.errorGenerator = new ErrorGeneration(error ,observation.getAvailableActions(true),replayer);
    }
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        Types.ACTIONS action = plans.get(maxFitnessIndex).get(0);
